...
export const sitemapEntries: MetadataRoute.Sitemap = [
  ...
  {
    url: `${SITE_URL}/despre-mine`,
    changeFrequency: "monthly",
    priority: 0.8,
  },
  {
    url: `${SITE_URL}/despre-meditatii`,
    changeFrequency: "weekly",
    priority: 0.9,
  },
  {
    url: `${SITE_URL}/planuri`,
    changeFrequency: "weekly",
    priority: 0.8,
  },
  {
    url: `${SITE_URL}/resurse-gratuite`,
    changeFrequency: "weekly",
    priority: 0.9,
  },
  {
...
export default function seoSitemap(): MetadataRoute.Sitemap {
