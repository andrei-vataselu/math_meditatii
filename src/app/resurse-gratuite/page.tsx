    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#5f0032] to-slate-900 overflow-hidden isolate">
      ...
      <main className="relative flex flex-col items-center justify-center min-h-[70vh] px-2 sm:px-6 py-8 sm:py-16 text-center">
        ...
        <div className="w-full max-w-4xl mx-auto bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-8 border border-white/20 shadow-2xl flex flex-col items-center gap-6 mb-8">
          <h2 className="text-2xl font-semibold text-white mb-2">Galerie de subiecte</h2>
          <p className="text-gray-200 mb-4">Vizualizează exemplele de subiecte la matematică</p>
          <PhotoCarousel photos={photos} />
          
          {/* Comanda acum button */}
          <div className="mt-6">
            <a
              href="https://wa.me/40731979588?text=Bună! Aș dori să comand meditații la matematică."
              target="_blank"
