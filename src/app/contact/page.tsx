    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#5f0032] to-slate-900 overflow-hidden isolate">
      ...
      <main className="relative flex flex-col items-center justify-center min-h-[70vh] px-2 sm:px-6 py-8 sm:py-16 text-center">
        ...
        <div className="w-full max-w-xl mx-auto bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-10 border border-white/20 shadow-2xl flex flex-col gap-4 sm:gap-6 items-center">
          <a href="mailto:dsmathcenter@gmail.com" className="flex items-center gap-3 sm:gap-4 w-full p-3 sm:p-4 rounded-lg hover:bg-white/20 transition-colors text-white text-base sm:text-lg font-medium break-words">
            <span className="bg-[#FEBFD2] bg-opacity-30 p-2 sm:p-3 rounded-full"><FaEnvelope size={22} /></span>
            <span className="break-words text-left">dsmathcenter@gmail.com</span>
          </a>
          <a href="tel:+40712345678" className="flex items-center gap-3 sm:gap-4 w-full p-3 sm:p-4 rounded-lg hover:bg-white/20 transition-colors text-white text-base sm:text-lg font-medium break-words">
            <span className="bg-[#FAD4E4] bg-opacity-30 p-2 sm:p-3 rounded-full"><FaPhoneAlt size={22} /></span>
            <span className="break-words text-left">0712 345 678</span>
          </a>
          <a href="https://chat.whatsapp.com/KXZcwE814NtLImYiBYkOBd" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 sm:gap-4 w-full p-3 sm:p-4 rounded-lg hover:bg-white/20 transition-colors text-white text-base sm:text-lg font-medium break-words">
            <span className="bg-[#25D366] bg-opacity-30 p-2 sm:p-3 rounded-full"><FaWhatsapp size={22} /></span>
            <span className="break-words text-left">WhatsApp</span>
          </a>
